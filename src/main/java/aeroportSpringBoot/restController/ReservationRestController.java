...
public class ReservationRestController {
		...
		public ResponseEntity<List<Reservation>> findByClient(Client client) {
		...
		public ResponseEntity<List<Reservation>> findByPassager(Passager passager) {
		...
		public ResponseEntity<List<Reservation>> findByVol(Vol vol) {
